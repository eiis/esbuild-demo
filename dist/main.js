  ...
  "node_modules/acorn/dist/acorn.js"(exports, module2) {
    (function(global, factory) {
      ...
      pp$12.regexp_eatCharacterClassEscape = function(state) {
        ...
        if (state.switchU && this.options.ecmaVersion >= 9 && ((negate = ch === 80) || ch === 112)) {
          ...
          if (state.eat(
            ...
            if (negate && result2 === CharSetString2) {
      ...
      pp$12.regexp_classSetExpression = function(state) {
        var result2 = CharSetOk2, subResult;
        if (this.regexp_eatClassSetRange(state))
          ;
        else if (subResult = this.regexp_eatClassSetOperand(state)) {
          if (subResult === CharSetString2) {
            result2 = CharSetString2;
          }
          var start = state.pos;
...
var espree_default = () => (Parser3) => {
  ...
  return class Espree extends Parser3 {
    ...
    finishNode(...args) {
      const result2 = super.finishNode(...args);
      return this[ESPRIMA_FINISH_NODE](result2);
    }
    finishNodeAt(...args) {
      const result2 = super.finishNodeAt(...args);
      return this[ESPRIMA_FINISH_NODE](result2);
    }
    parse() {
      const extra = this[STATE];
    ...
    */
    jsx_readString(quote) {
      const result2 = super.jsx_readString(quote);
     ...
     */
    [ESPRIMA_FINISH_NODE](result2) {
      if (result2.type === "TemplateElement") {
        this[STATE].templateElements.push(result2);
      }
      if (result2.type.includes("Function") && !result2.generator) {
        result2.generator = false;
      }
      return result2;
    }
  };
...
var ast = parse3('let foo = "bar"', { ecmaVersion: 6 });
